...
func TestCommercialColorsProductSave(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "active creation without color", create: true, active: true},
		{name: "active edit without color", active: true},
		...
		{name: "can remove final color while active", wasActive: true, active: true, hadColor: true},
