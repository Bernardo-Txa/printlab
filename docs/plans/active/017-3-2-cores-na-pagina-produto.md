...
- Refinamento visual: componente `ProductColorSelector` em card arredondado, swatches de 48 px sem lista textual, contorno azul e marca de selecao. Nomes mantidos nos atributos acessiveis e tooltip; somente o nome escolhido aparece abaixo.
